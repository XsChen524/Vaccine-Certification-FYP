...
#include <../depends/libsnark/common/data_structures/merkle_tree.hpp>
#include <../depends/libsnark/gadgetlib1/gadgets/basic_gadgets.hpp>
#include <../depends/libsnark/gadgetlib1/gadgets/hashes/hash_io.hpp>
#include <../depends/libsnark/gadgetlib1/gadgets/hashes/sha256/sha256_components.hpp>
...
template<typename FieldT>
class sha256_multi_to_one_hash_gadget : public gadget<FieldT> {
public:
    typedef libff::bit_vector hash_value_type;
    typedef merkle_authentication_path merkle_authentication_path_type;
    ...
    sha256_multi_to_one_hash_gadget(protoboard<FieldT> &pb,

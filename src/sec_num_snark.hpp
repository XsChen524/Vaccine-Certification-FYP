...
#include "sec_num_gadget.hpp"

using namespace libsnark;
using namespace std;

/*
	Generate Proving Key and Verification Key for the zk-SNARKs
*/
                                                                   ...
                                                                   )
{
    ...
    protoboard<FieldT> pb;
    l_gadget<FieldT> sn(pb);
    sn.generate_r1cs_constraints();
    sn.generate_r1cs_witness(h1, h2, x, r1, r2);
